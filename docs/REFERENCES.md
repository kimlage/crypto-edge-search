...
- **`[CORRECTED]` BIS WP 1087 "Crypto carry"** is by **Schmeling, Schrimpf & Todorov (2023)** — *not* "Aramonte, Huang & Schrimpf" as stated in a prior published version of this bibliography. Verified at [bis.org/publ/work1087](https://www.bis.org/publ/work1087.htm). (Aramonte, Huang & Schrimpf 2021, "DeFi risks and the decentralisation illusion", *BIS Quarterly Review*, is a different, real paper.)

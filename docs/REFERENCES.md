...
> **35 tested hypotheses** traces to a peer-reviewed paper or a public working paper.
...
killed 33 of 35 hypotheses net of realistic cost, leaving only two structural-carry
...
- [`EDGE_SEARCH_SYNTHESIS.md`](EDGE_SEARCH_SYNTHESIS.md) — the durable map: 35 hypotheses, 33 KILL, 2 sub-RF carry survivors; where the edge is *not*; the methodology that works.

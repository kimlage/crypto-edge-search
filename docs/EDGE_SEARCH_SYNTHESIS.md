...
> whole program: 28 crypto trading hypotheses tested under an anti-overfitting validation
> harness; 26 killed; 2 structural-carry "survivors" that are real but sub-risk-free in
> the current regime.
>
...
- **28 distinct hypotheses tested** at full rigor on real public data (cloud $0).
- **26 KILL** — every prediction / technical-analysis / relative-value / rotation / event-flow
...
- **The one durable asset of this project is the methodology**: committed gates +
  ...
  killed 26 pretty in-sample Sharpes that would otherwise have looked like wins — including
...
**Totals: 26 KILL — every prediction / TA / relative-value / rotation / event-flow / evolved-rule
...
within the 26 KILL — 28 distinct hypotheses, 26 killed, 2 carry survivors.)
...
> **A KILL is a valuable, honest outcome.** The empty parent pool / 26 kills are the gates working

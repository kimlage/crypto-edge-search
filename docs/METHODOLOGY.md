...
> POC) we tested **28 distinct crypto trading hypotheses** on real public data at full rigor
> (cloud spend $0). **26 were killed.** The two "survivors" are structural carry — real edges that have
...
| Bucket | Count | Notes |
|---|---|---|
| Hypotheses tested at full rigor | **28** | six rounds + an on-chain POC, all on real public data, cloud spend $0 |
| Killed | **26** | every prediction / TA / relative-value / rotation / on-chain-flow idea, **fixed and adaptive** |
